...
export default class TodoService {
  public static async GetTodos(email: string, listId: string): Promise<ITodo[]> {
    try {
  ...
  public static async CreateTodo(email: string, listId: string, todo: ITodo): Promise<number | undefined> {
    try {
  ...
  public static async UpdateTodo(email: string, listId: string, todo: ITodo): Promise<number | undefined> {
    try {
  ...
  public static async DeleteTodo(email: string, listId: string, todoId: number): Promise<number | undefined> {
    try {
